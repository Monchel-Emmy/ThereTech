...
const Projects = () => {
  ...
  const testimonials = [
    {
      quote:
        "The team helped me turn my final year project into a working prototype. Their mentorship was invaluable to my academic success.",
    ...
    {
      quote:
        "Professional, reliable, and innovative. There Tech delivered our Rwadiscount platform on time and exceeded our expectations.",
    ...
    {
      quote:
        "There Tech Helped me during my masters degree project which was smart parking System",
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center text-white">
            ...
            <p className="text-xl text-blue-100 leading-relaxed max-w-3xl mx-auto mb-12">
              Discover how we've transformed ideas into digital solutions that
              drive success for businesses and students alike.
            </p>
                      ...
                      <div className="absolute top-4 right-4">
                        <span
                          className={`px-3 py-1 bg-gradient-to-r ${getStatusColor(
                            project.status
                          )} text-white text-sm font-semibold rounded-full backdrop-blur-sm`}
                        >
                          {project.status}
                        </span>
                      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Hear from students and businesses we've helped succeed
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
              >
                {/* Rating Stars */}
