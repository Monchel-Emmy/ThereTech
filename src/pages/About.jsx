        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center text-white">
            <div className="inline-flex items-center justify-center mb-4 md:mb-6 px-4 py-2 md:px-6 md:py-3 bg-white/10 backdrop-blur-md rounded-full border border-white/20 shadow-lg">
              ...
              <span className="font-semibold text-xs md:text-sm uppercase tracking-widest">Our Story</span>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-12 md:mb-16">
            <div className="flex items-center justify-center mb-4 md:mb-6">
              ...
              <span className="text-blue-600 font-bold uppercase tracking-widest text-xs md:text-sm">Our Purpose</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6">
                {[
                  ...
                  { number: aboutData.stats.clientsServed, label: 'Happy Clients', icon: Users, color: 'from-blue-500 to-indigo-600' }
                ].map((stat, index) => {
                  const IconComponent = stat.icon;
                  return (
                    <div key={index} className="group text-center bg-white/80 backdrop-blur-md rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 md:hover:-translate-y-2">
                      <div className={`w-12 h-12 md:w-16 md:h-16 bg-gradient-to-br ${stat.color} rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-3 md:mb-4`}>
        ...
        <section className="py-12 md:py-20">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="text-center py-12 md:py-20">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-red-600 mb-3 md:mb-4">Connection Error</h3>
              <button 
      ...
      <section className="py-12 md:py-16 lg:py-20 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <div className="flex items-center justify-center mb-4 md:mb-6">
              <div className="w-8 md:w-12 h-0.5 bg-blue-500 mr-3 md:mr-4"></div>
              <span className="text-blue-600 font-bold uppercase tracking-widest text-xs md:text-sm">Our Values</span>
              <div className="w-8 md:w-12 h-0.5 bg-blue-500 ml-3 md:ml-4"></div>
            </div>
              ...
              return (
                <div key={index} className="group relative">
                  <div className="relative bg-white rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 md:hover:-translate-y-2 border border-blue-100/50 h-full">
                    ...
                    {/* Content */}
                    <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2 md:mb-3">{value.title}</h3>
                    <p className="text-gray-600 leading-relaxed text-xs md:text-sm">{value.description}</p>
                  </div>
                </div>
              );
            })}
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-br from-white to-blue-50/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <div className="flex items-center justify-center mb-4 md:mb-6">
              <div className="w-8 md:w-12 h-0.5 bg-blue-500 mr-3 md:mr-4"></div>
              <span className="text-blue-600 font-bold uppercase tracking-widest text-xs md:text-sm">Our Team</span>
              <div className="w-8 md:w-12 h-0.5 bg-blue-500 ml-3 md:ml-4"></div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            {teamList.map((member, index) => (
              <div key={index} className="group relative bg-white rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 md:hover:-translate-y-2 overflow-hidden">
                <div className="relative z-10 p-4 md:p-6">
                  ...
                  <div className="flex items-center space-x-3 md:space-x-4 mb-3 md:mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="text-base md:text-lg font-bold text-gray-900 mb-1 truncate">{member.name}</h3>
                  ...
                  {/* Bio */}
                  <p className="text-gray-600 leading-relaxed text-xs md:text-sm mb-3 md:mb-4">{member.bio}</p>

                  {/* Social Links */}
                  <div className="flex space-x-2">
                    <a href="#" className="w-6 h-6 md:w-7 md:h-7 bg-gray-100 rounded md:rounded-lg flex items-center justify-center text-gray-600 hover:bg-blue-600 hover:text-white transition-all duration-300">
                      <Linkedin className="w-3 h-3 md:w-4 md:h-4" />
                    </a>
                    <a href="#" className="w-6 h-6 md:w-7 md:h-7 bg-gray-100 rounded md:rounded-lg flex items-center justify-center text-gray-600 hover:bg-gray-900 hover:text-white transition-all duration-300">
                      <Github className="w-3 h-3 md:w-4 md:h-4" />
                    </a>
                    <a href="#" className="w-6 h-6 md:w-7 md:h-7 bg-gray-100 rounded md:rounded-lg flex items-center justify-center text-gray-600 hover:bg-red-600 hover:text-white transition-all duration-300">
